import type { DeveloperContext, ExplainableFinding, GitDiff, PatchCandidate, PatchPlan, RetrievalBundle, ReviewSession } from './index.js';
export interface RepositoryService {
    indexRepository(repoPath: string): Promise<{
        indexedFiles: number;
        durationMs: number;
    }>;
...
export interface ReviewService {
    runReview(diff: GitDiff): Promise<{
...
//# sourceMappingURL=internal-services.types.d.ts.map
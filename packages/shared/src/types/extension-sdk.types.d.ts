...
export type ExtensionCategory = 'review-agent' | 'language' | 'exporter' | 'workflow' | 'ai-provider' | 'ui';
...
export type WorkflowHookType = 'beforeIndexing' | 'afterIndexing' | 'beforeReview' | 'afterReview' | 'beforePatchGeneration' | 'afterPatchGeneration' | 'beforeReportGeneration' | 'afterReportGeneration';
...
//# sourceMappingURL=extension-sdk.types.d.ts.map